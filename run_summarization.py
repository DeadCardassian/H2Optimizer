...
if __name__ == '__main__':
    ...
    parser.add_argument("--seed", type=int, default=28, help="random seed for initialization")
    ...
    #print(args.num_heavy_hitter_tokens)
    ...
    with torch.no_grad():
        for request in tqdm.tqdm(requests):
            ...
            print("token length:", request['max_tokens'])
